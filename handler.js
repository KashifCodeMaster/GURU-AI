...
global.dfail = (type, m, conn, usedPrefix) => {
    ...
    const msg = {
        ...
        group: [
            ...
            `*${emoji.group} This command can be used in group only!* 🍸\nAccess granted only to the groupies. Gather your comrades and try it there.`,
        ],
        private: [
            `*${emoji.private} Private Party Time!* 📱\nThis command can only be used in private chats!`,
            `*${emoji.private} Keep It Hush-Hush!* 🤐\nThis command is for one-on-one moments (works in private chat, haha)!`,
            `*${emoji.private} Private Territory!* 🏡\nNot for public use, this is a private affair! This command can only be used in private chat.`,
            `*${emoji.private} Confidential Zone!* 🔐\nRestricted access! This command works in private conversations only!`,
        ],
        admin: [
            ...
            `*${emoji.admin} Secure Area!* 🔒\nRestricted entry – admin eyes only! You can't use this command, sorry!`,
        ],
        botAdmin: [
            `*${emoji.botAdmin} I'm Not In Charge Here!*\nMake me an admin first! 🤖`,
            `*${emoji.botAdmin} Alert! Permission Denied!* 🚫\nAdmin status required for this command! Grant me admin previleges.)`,
            `*${emoji.botAdmin} Unauthorized Access!* 🤖\nThis command needs bot admin clearance!`,
            `*${emoji.botAdmin} Admin Previleges Needed!* 🛡️\nMake me an admin to use commands smoothly!`,
        ],
        unreg: [
            `*${emoji.unreg} Registration Required!* 🔒\nHold on, cowboy! You need to register first. Use *.register name.age.gender*!`,
            `*${emoji.unreg} Time to Sign Up!* ✍️\nNo entry without proper registration. Give *.register* a shot!`,
            `*${emoji.unreg} Sign Up First!* 📝\nRegistration is the key to unlock this feature! Use *.register* to register.`,
            `*${emoji.unreg} Membership Required!* 🚪\nOnly registered users are allowed here. Join the club by using *.register*`,
        ],
        nsfw: [
            `*${emoji.nsfw} NSFW Alert!* 🔞\nWarning! NSFW is inactive. Talk to the group admin to allow NSFW access in current chat and spice things up!`,
            `*${emoji.nsfw} Sensual Content Alert!* 💋\nNSFW is on vacation. Request some excitement by asking Admin to allow the access to NSFW content!`,
            `*${emoji.nsfw} Adult Content Warning!* 🚨\nSorry, this zone is currently family-friendly! Ask admin to enable the NSFW access`,
            `*${emoji.nsfw} Spice It Up Request!* 🌶️\nNSFW is resting – contact admin for some heat! Ask Admin to turn on the NSFW acess in current chat.`,
        ],
        restrict: [
